...
export class WidgetAttachmentPage {
    /**
    * Index of the page (1-based)
    */
    'index': number;
    'previewSmallUrl'?: string;
    'previewSmallLarge'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "previewSmallUrl",
            "baseName": "previewSmallUrl",
            "type": "string"
        },
        {
            "name": "previewSmallLarge",
            "baseName": "previewSmallLarge",
            "type": "string"
        }    ];

    static getAttributeTypeMap() {
        return WidgetAttachmentPage.attributeTypeMap;
    }
}
