...
export class WidgetSessionResponseLegacy {
    'data'?: WidgetSessionResponseItem;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "WidgetSessionResponseItem"
        }    ];

    static getAttributeTypeMap() {
        return WidgetSessionResponseLegacy.attributeTypeMap;
    }
}
