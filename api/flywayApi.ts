...
export enum FlywayApiApiKeys {
    AccessToken,
}

export class FlywayApi {
    ...
    public setApiKey(key: FlywayApiApiKeys, value: string) {
        (this.authentications as any)[FlywayApiApiKeys[key]].apiKey = value;
    }
